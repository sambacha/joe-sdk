...
var SOLIDITY_TYPE_MAXIMA = (_SOLIDITY_TYPE_MAXIMA = {}, _SOLIDITY_TYPE_MAXIMA[SolidityType.uint8] = /*#__PURE__*/JSBI.BigInt('0xff'), _SOLIDITY_TYPE_MAXIMA[SolidityType.uint256] = /*#__PURE__*/JSBI.BigInt('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff'), _SOLIDITY_TYPE_MAXIMA); // export const MaxUint256 = JSBI.BigInt('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff')
...
var FARMLENS_ADDRESS = (_FARMLENS_ADDRESS = {}, _FARMLENS_ADDRESS[ChainId.RINKEBY] = '0x7984D02320aA22e6A3cDAc3Af14E7f1820ac7aAa', _FARMLENS_ADDRESS[ChainId.FUJI] = '0x0000000000000000000000000000000000000000', _FARMLENS_ADDRESS[ChainId.AVALANCHE] = '0xc1b83cE1573984Dcf4115e983F9c28748a0F350E', _FARMLENS_ADDRESS);
...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, chainId) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) == null ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) == null ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) == null ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = getCreate2Address(FACTORY_ADDRESS[chainId], keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH), _extends2)), _extends3));
    }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return new Contract(address, IJoePair.abi, provider).getReserves();
...
var _BLOCKS_SUBGRAPH, _EXCHANGE_SUBGRAPH, _MASTERCHEF_SUBGRAPH, _DEXCANDLES_SUBGRAPH, _BAR_SUBGRAPH, _LENDING_SUBGRAPH;
...
export { BAR_ADDRESS, BAR_SUBGRAPH, BLOCKS_SUBGRAPH, BORINGDASHBOARD_ADDRESS, BORINGHELPER_ADDRESS, BORINGHELPER_MCV3_ADDRESS, BORINGTOKENSCANNER_ADDRESS, CAVAX, ChainId, Currency, CurrencyAmount, DEXCANDLES_SUBGRAPH, EXCHANGE_SUBGRAPH, FACTORY_ADDRESS, FARMLENS_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, JAVAX_ADDRESS, JOELENSVIEW_ADDRESS, JOELENS_ADDRESS, JOE_ADDRESS, JSBI, LENDING_SUBGRAPH, MAKER_ADDRESS, MASTERCHEF_ADDRESS, MASTERCHEF_SUBGRAPH, MASTERCHEF_V3_ADDRESS, MAXIMILLION_ADDRESS, MINIMUM_LIQUIDITY, Pair, Percent, Price, ROLL_ADDRESS, ROUTER_ADDRESS, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, UNITROLLER_ADDRESS, WAVAX, ZAP_ADDRESS, currencyEquals, inputOutputComparator, tradeComparator };
