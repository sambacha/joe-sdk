...
var FARMLENS_ADDRESS = (_FARMLENS_ADDRESS = {}, _FARMLENS_ADDRESS[exports.ChainId.RINKEBY] = '0x7984D02320aA22e6A3cDAc3Af14E7f1820ac7aAa', _FARMLENS_ADDRESS[exports.ChainId.FUJI] = '0x0000000000000000000000000000000000000000', _FARMLENS_ADDRESS[exports.ChainId.AVALANCHE] = '0xc1b83cE1573984Dcf4115e983F9c28748a0F350E', _FARMLENS_ADDRESS);
...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, chainId) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) == null ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) == null ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) == null ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(FACTORY_ADDRESS[chainId], solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH), _extends2)), _extends3));
    }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return new contracts.Contract(address, IJoePair.abi, provider).getReserves();
